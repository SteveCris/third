...
public class RedisPrefix {
	...
	public static final String CONFIG_BASE_C = "CONFIG:OBASE:C:";
	
	public static final String CONFIG_SCENE = "CONFIG:OSCENE:";
	
	public static final String CONFIG_SCENE_SUPER = "CONFIG:OSCENE:S:";
	
	public static final String CONFIG_SCENED = "CONFIG:OSCENED:";
	
	public static final String CONFIG_SCENED_B = "CONFIG:OSCENED:B:";
	
	public static final String RISK_CLICK = "RISK:C:";
