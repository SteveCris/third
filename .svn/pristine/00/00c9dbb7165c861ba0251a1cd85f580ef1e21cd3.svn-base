...
public class ZlqbLinkman implements Serializable {
    //联系人id
    ...
    public ZlqbLinkman(String linkId, String orderNo, String name, String mobile, String type, Date createTime, String ext1, String ext2) {
        this.linkId = linkId;
